...
This contract model applies across the Parameters, Composition, and Recipes
layers defined in the [Working Design Brief](./design-doc.md#a-minimal-model).
The current color work instantiates the parameter case first.
