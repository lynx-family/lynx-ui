...
- Add `unmountOnExit` as a clearer alias for lazy content unmount behavior and deprecate `unloadable` while keeping backward compatibility. ([#79](https://github.com/lynx-family/lynx-ui/pull/79))
