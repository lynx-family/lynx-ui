...
一个适用于 ReactLynx 的 Presence 组件，用于处理元素进入和离开视图树时的动画。
...
_（如有需要，也可以通过 `pnpm add @lynx-js/lynx-ui-presence` 单独安装该包）_

## 使用

[查看完整示例](https://github.com/lynx-family/lynx-ui/tree/main/apps/examples/Presence)
