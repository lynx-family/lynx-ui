...
`@lynx-js/lynx-ui` 组件共享的通用工具、Hooks 和类型定义。
...
_（如有需要，也可以通过 `pnpm add @lynx-js/lynx-ui-common` 单独安装该包）_

## 使用

[查看完整示例](https://github.com/lynx-family/lynx-ui/tree/main/apps/examples/Common)

## 组件结构

将该包作为 Lynx UI 组件和工具的共享依赖使用。
