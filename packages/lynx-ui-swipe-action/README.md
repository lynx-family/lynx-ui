...
A SwipeAction component for Lynx. It provides swipeable list item primitives via main-thread gestures.
...
_(If necessary, you can still install the standalone package via `pnpm add @lynx-js/lynx-ui-swipe-action`)_

## Usage

The `lynx-ui-swipe-action` follows a headless composition pattern.

[View Full Examples](https://github.com/lynx-family/lynx-ui/tree/main/apps/examples/SwipeAction)
