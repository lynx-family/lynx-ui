...
const labels = ['For you', 'Following creators', 'Friends', 'Live']
...
export function App() {
  return (
    <view className='tab-group-demo lunaris-dark'>
      <text className='tab-group-demo__title'>Different tab widths</text>
      <TabsRoot>
        <TabsBar
          data={tabs}
          className='tab-group-demo__tabs'
          tabsItemWrapperClass='tab-group-demo__tabs-inner'
          renderTabItem={item => (
            <TabsItem
              className='tab-group-demo__tab-item tab-group-different-width__item'
